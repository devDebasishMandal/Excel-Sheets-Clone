...
function highlightOptionsButtonOnFocus() {
  ...
  // } else {
  //   //if in the state of that cell isBoldSelected is false
  ...
  // } else {
  //   //if in the state of that cell isItalic is false
...
function onCellFocus(event) {
  ...
  activeOptionsState = {
    ...
    textAlign: computedStyle.textAlign, //or start or center orleft 
    textColor: computedStyle.color,
    backgroundColor: computedStyle.backgroundColor,
    fontSize: computedStyle.fontSize,
  };
  highlightOptionsButtonOnFocus();
  console.log(activeOptionsState.fontFamily);
}
